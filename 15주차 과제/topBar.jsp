	...
	<nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background: #96DFD8;: white;">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<li class="nav-item dropdown active dropdown has-megamenu">
					<a class="nav-link dropdown-toggle caret" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Dropdown </a>
<!------------------------------ dropdown mega menu ---------------------------------------------->
                        ...
                        <div class="col-md-3">
                            <div class="col-megamenu m-2 ">
	                            ...
	                            <ul class="list-unstyled ">
	                                <li><a class="text-dark" href="#">Custom Menu</a></li>
	                                <li><a class="text-dark" href="#">Custom Menu</a></li>
	                                <li><a class="text-dark" href="#">Custom Menu</a></li>
	                                <li><a class="text-dark" href="#">Custom Menu</a></li>
	                                <li><a class="text-dark" href="#">Custom Menu</a></li>
...
<!------------------------------ dropdown mega menu 하단줄 ---------------------------------------------->
                        <div class="row px-5 mx-5">
                        
<!------------------------------ dropdown mega menu 데이터5 ---------------------------------------------->
                         <div class="col-md-3">
                        	<div class="col-megamenu m-2">
                            <h6 class="title">Title Menu Four</h6>
                                 <ul class="list-unstyled ">
			...
			<ul class="navbar-nav px-5">
				<li class="nav-item dropdown active">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="/JSPProject/Finish/마이페이지/마이페이지%20화면/main.jsp">마이페이지</a>
						<div class="dropdown-divider"></div>
						<a class="dropdown-item" href="#">로그아웃</a>
						<div class="dropdown-divider"></div>
						<a class="dropdown-item" href="/JSPProject/Finish/마이페이지/장바구니/main.jsp">장바구니</a>
						<div class="dropdown-divider"></div>
