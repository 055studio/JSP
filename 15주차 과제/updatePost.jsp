...
<body>
	...
	<form action="updatePostPro.jsp" method="post">
		...
		<div class="container text-center">
			...
			<br>
			<h2 class="font-weight-bold">게시글 수정</h2>
			...
			<div class="text-center">
				...
				<input type="text" class="form-control" name="writer" id="writer" placeholder="" value="<%=session.getAttribute("id") %>" required="" readonly>
			</div>
			...
			<div class="text-center">
				...
				<textarea class="form-control" name="content" id="content" rows="3" onkeydown="resize(this)" onkeyup="resize(this)"><%=content %></textarea>
			</div>
